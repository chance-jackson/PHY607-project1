...
import numpy as np
from scipy.constants import epsilon_0, elementary_charge, hbar
...
r1 = 1
r2 = [10,25,50,75,100,250,500,750,1000,2500,5000,7500,10000]

def small_angle_analytic(r1,r2):
...
step_sizes = np.array([0.00001,0.0001,0.001,0.01,0.1,0.25,0.5,1])
N_steps = (r2-r1)/step_sizes

simpson_error, trapz_error = [],[]
analytic_val = analytic(r1,r2)
for i in range(len(N_steps)):

    simpson_val = func.simpson(gamow_integral, r1, r2, int(N_steps[i]))
...
plt.scatter(step_sizes, simpson_error, label= "Simpson")
